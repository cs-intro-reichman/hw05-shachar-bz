...
public class GameOfLife {
	...
	public static int[][] read(String fileName) {
		...
		while(!in.isEmpty()){
			...
			int indexColumn = 1;
			if(place != ""){
				for(int indexPlace = 0; indexPlace < place.length(); indexPlace++){
					if(place.charAt(indexPlace) == 'x'){
